<div>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between my-2 gap-2 row">
            <div class="col-2">
                <input type="search" wire:model.live="filters.search" name="" id="" placeholder="Search ... "
                    class="form-control">
            </div>
            ...
            <div class="col">
                <a href="{{ route('my-evaluation-lists-final-grading',[
                        ...
                        'semester' => $semester,
                        'schedule_id' => $detail['schedule_id']]) }}" class="btn btn-outline-secondary"
                    target="_blank">
                    Final Grading
                </a>
            </div>
            ...
            <div class="d-flex col justify-content-end gap-2">
                ...
                <button class="btn btn-primary" wire:click="open_school_work_types_modal('addSchoolWorkTypeModal')"
                    data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top"
                    data-bs-content="Manage School Work Types">
                    <svg fill="currentColor" width="20px" viewBox="-8 0 32 32" version="1.1"
                ...
                {{-- CSV Export Button - uses different function based on schedule type --}}
                @if($schedule->is_lec == 0)
                {{-- Laboratory Schedule - use LabType export --}}
                <button class="btn btn-outline-success" wire:click="exportCSVLabType" data-bs-toggle="popover"
                    data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Export to CSV">
                    <svg viewBox="0 0 24 24" height="20px" width="20px" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                @else
                {{-- Lecture Schedule - use standard export --}}
                <button class="btn btn-outline-success" wire:click="exportCSV" data-bs-toggle="popover"
                    data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Export to CSV">
                    <svg viewBox="0 0 24 24" height="20px" width="20px" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                ...
                {{-- Excel Export Button - uses different function based on schedule type --}}
                @if($schedule->is_lec == 0)
                {{-- Laboratory Schedule - use LabType export --}}
                <button class="btn btn-outline-success" wire:click="exportExcelLabType" data-bs-toggle="popover"
                    data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Export to Excel">
                    <svg viewBox="0 0 24 24" height="20px" width="20px" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path d="M14 2V8H20" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            <path d="M10 13L14 17" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            <path d="M14 13L10 17" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                        </g>
                    </svg>
                </button>
                @else
                {{-- Lecture Schedule - use standard export --}}
                <button class="btn btn-outline-success" wire:click="exportExcel" data-bs-toggle="popover"
                    data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Export to Excel">
                    <svg viewBox="0 0 24 24" height="20px" width="20px" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                ...
                <a href="{{ route('my-enrolled-students',[
                    ...
                    class="btn btn-outline-secondary d-flex justify-content-center align-items-center" wire:navigate
                    data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top"
                    data-bs-content="View My Enrolled Students">
                    <svg fill="currentColor" viewBox="0 -64 640 640" width="20px" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path
        ...
        <div class="row " style="min-width:800px;">
            <div class="table-responsive">
                <table class="table table-striped table-bordered text-center align-middle " style="overflow-x: auto;">
                    <div wire:target="filters.search perPage, nextPage, previousPage, gotoPage" wire:loading.flex>
                    ...
                    <thead style="background:#952323;color:white;">
                        <tr class="align-middle">
                            ...
                            <th colspan="{{ ( $school_works_var->total >0 ? intval($school_works_var->total) + 1: 1) }}"
                                class="text-center">{{$value->school_work_type}} {{ number_format($value->weight
                                /$weight->total_weight * 100, 2, '.', '') }}%</th>
                            @else
                            <th colspan="1" class="text-center">{{$value->school_work_type}} {{
                                number_format($value->weight / $weight->total_weight * 100 , 2, '.', '') }}%</th>
                            @endif
                            @endif
                            @empty
                        ...
                        <tr class="align-middle">
                            ...
                            @if($value->id != $current_school_work_type->id)
                            <th class="text-center">{{ $v_value->school_work_name }} : {{ $v_value->max_score }}<br>{{
                                date_format(date_create($v_value->schedule_date) ,"M d, Y");}}</th>
                            @else

                            @endif
                            @endforeach
                            <th class="text-center">Avg - {{ number_format($value->weight /$weight->total_weight * 100,
                                2, '.', '') }}%</th>
                            @else
                    ...
                    <tbody>
                        ...
                        <tr class="align-middle">
                            <th scope="row" class="px-4">{{($table_data->currentPage()-1)*$table_data->perPage()+$key+1
                                }}</th>
                            <td class="text-start">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="/faculty/students/view-{{ $value->id }}/schedule-{{ $detail['schedule_id'] }}/"
                                        ...
                                        <span>
                                            <svg viewBox="0 0 1024 1024" width="20px" class="icon" version="1.1"
                            ...
                            @if($v_value['school_work_type_id'] != $current_school_work_type->id)
                            <td class=""
                                wire:key="{{ $value->id.'-'.$v_value['school_work_type_id'].'-'.$v_value['score']}}">
                                <div class="d-flex align-middle">
                                    <input type="number" name="" id="" value="{{ $v_value['score'] }}"
                                        class="form-control" style=" min-width:100px;" wire:change="updateScore(
                            ...
                            'grade' => ($current_term_grade && floatval($current_term_grade->grade) ?
                            $current_term_grade->grade * $lab_lec->sub_weight/100 : NULL),
                            'other' => NULL,
                            ]);
                            $lab_lec_grades = DB::table('lab_lec_grades')
                            ->where('schedule_id','=',$detail['schedule_id'])
                            ...
                            'schedule_id' => $detail['schedule_id'],
                            'sub_weight' => $lab_lec->sub_weight,
                            'grade' => (floatval($current_term_grade->grade) ? $current_term_grade->grade *
                            $lab_lec->sub_weight/100 : NULL),
                            ]);
                            ...
                            <td>
                                ...
                                <input type="text" class="form-control" value="{{$grade }}"
                                    wire:change="updateLabLecGrades({{ $lab_lec_grades->id }},{{ $value->id }},$event.target.value)">
                                @endif
                                @endif
                            </td>
                            ...
                            <th scope="col" class="">
                                ...
                                $current_term = collect($terms)->firstWhere('id', $detail['term_id']);
                                $term_type = $current_term ? $current_term->term_name : 'Midterm'; // Midterm or
                                Finalterm
        ...
        <div class="modal fade" id="addSchoolWorkTypeModal" wire:ignore.self data-bs-backdrop="static"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" id="addSchoolWorkTypeModalclose"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body row">
                        <div class="col-md-6 mb-3">
                            <label for="school_work_type" class="form-label">School Work Type</label>
                            <input type="text" id="school_work_type"
                                wire:model.defer="school_work_type.school_work_type" placeholder="School work type"
                                class="form-control @error('school_work_type.school_work_type') is-invalid @enderror">
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <input type="weight" min="0.0" step="0.1" id="weight"
                                wire:model.defer="school_work_type.weight"
                                class="form-control @error('school_work_type.weight') is-invalid @enderror">
                        ...
                        <div class="col align-bottom">
                            ...
                            <button class="btn btn-primary "
                                wire:click="add_school_work_type({{ $detail['schedule_id'] }},'addSchoolWorkTypeModal')">
                                Add
                            </button>
                        </div>
                        <div class="col-12">
                            <table
                                class="table table-striped table-bordered text-center align-middle position-relative">
                                <thead style="background:#952323;color:white;">
                                    <tr class="align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="px-4">
                                            <input type="number" name="" id="" value="{{ $value->weight }}"
                                                wire:model="school_work_type_value.{{ $key }}.val"
                                                wire:change="updateSchoolWorktype('{{$value->id }}', $event.target.value)"
                                                class="form-control" placeholder="weight" min="0.0" step="0.1">
                                        </td>
                                        <td class="px-4">
                                            @if($weight->total_weight)
                                        ...
                                        <td class="d-flex justify-content-center text-center">
                                            <button wire:click="deleteSchoolWorkType({{$value->id }})" type="button"
                                                wire:wire:navigate
                                                class="btn btn-outline-danger d-flex justify-content-center items-center">
                                                <svg fill="currentColor" width="20px" viewBox="0 0 64 64" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                                    <g id="SVGRepo_iconCarrier">
                                                        <rect id="Icons" x="-64" y="-64" width="1280" height="800"
                                                        ...
                                                        <g id="Icons1" serif:id="Icons">
                                                            ...
                                                            <g id="trash">
                                                                ...
                                                                <rect x="22.58" y="28.099" width="3" height="16.327"
                                                                    style="fill-rule:nonzero;"></rect>
                                                                <rect x="30.571" y="28.099" width="3" height="16.327"
                                                                    style="fill-rule:nonzero;"></rect>
                                                                <rect x="38.58" y="28.099" width="3" height="16.327"
                                                                    style="fill-rule:nonzero;"></rect>
                                                            </g>
                                    ...
                                    <tr class="align-middle">
                                        <td colspan="42">
                                            <div class="alert alert-danger d-flex justify-content-center">No records
                                                found!</div>
                                        </td>
                                    </tr>
                                    @endforelse
        ...
        <div class="modal fade" id="addSchoolWorkModal" wire:ignore.self data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <form wire:submit.prevent="add_school_work('addSchoolWorkModal')" class="w-100">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" data-bs-dismiss="modal" id="addSchoolWorkModalclose"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body row">
                            <div class="col-6 mb-3">
                                <label for="school_work_type_id" class="form-label">School work type</label>
                                <select name="school_work_type_id" id="school_work_type_id"
                                    class="form-control @error('school_work.school_work_type_id') is-invalid @enderror"
                                    wire:model.live="school_work.school_work_type_id">
                            ...
                            <div class="col-6 mb-4">
                                ...
                                <input type="date" name="schedule_date" id="schedule_date"
                                    wire:model="school_work.schedule_date"
                                    class="form-control @error('school_work.schedule_date') is-invalid @enderror">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="school_work" wire:model.defer="school_work.school_work_name"
                                    placeholder="School work type"
                                    class="form-control @error('school_work.school_work_name') is-invalid @enderror">
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="max_score" min="0.0" step="1" id="max_score"
                                    wire:model="school_work.max_score"
                                    class="form-control @error('school_work.max_score') is-invalid @enderror">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="px-4">
                                                ...
                                                wire:change="updateSchoolWorkName({{ $value->id }},
                                                $event.target.value)"
                                                >
                                            </td>
                                            <td class="px-4">
                                                <input type="date" class="form-control" name=""
                                                    value="{{ \Carbon\Carbon::parse($value->schedule_date)->format('Y-m-d')}}"
                                                    id=""
                                            ...
                                            <td class="d-flex justify-content-center gap-1 text-center">
                                                <button wire:click="deleteSchoolWork({{$value->id }})" type="button"
                                                    wire:wire:navigate
                                                    class="btn btn-outline-danger d-flex justify-content-center items-center">
                                                    <svg fill="currentColor" width="20px" viewBox="0 0 64 64"
                                                        ...
                                                        <g id="SVGRepo_iconCarrier">
                                                            ...
                                                            <g id="Icons1" serif:id="Icons">
                                                                ...
                                                                <g id="trash">
                                                                    ...
                                                                    <rect x="22.58" y="28.099" width="3" height="16.327"
                                                                        style="fill-rule:nonzero;"></rect>
                                                                    <rect x="30.571" y="28.099" width="3"
                                                                        height="16.327" style="fill-rule:nonzero;">
                                                                    </rect>
                                                                    <rect x="38.58" y="28.099" width="3" height="16.327"
                                                                        style="fill-rule:nonzero;"></rect>
                                                                </g>
        ...
        <div class="modal fade" id="detailModal" wire:ignore.self data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <form class="w-100">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" data-bs-dismiss="modal" id="detailModalclose"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body row">
                            @if($schedule)
                            <ul class="list-group">
                                <li class="list-group-item"><span><strong> School year:</strong> {{
                                        $schedule->school_year }}</span></li>
                                <li class="list-group-item"><span><strong> College:</strong> {{ $schedule->college
                                        }}</span></li>
                                <li class="list-group-item"><span><strong> Department:</strong> {{ $schedule->department
                                        }}</span></li>
                                <li class="list-group-item"><span><strong> Faculty name:</strong> {{
                                        $schedule->faculty_fullname }}</span></li>
                                <li class="list-group-item"><span><strong> Semester:</strong> {{ $schedule->semester
                                        }}</span></li>
                                <li class="list-group-item"><span><strong> Year Level:</strong> {{ $schedule->year_level
                                        }}</span></li>
                                <li class="list-group-item"><span><strong> Subject:</strong> {{ $schedule->subject
                                        }}</span></li>
                                <li class="list-group-item"><span><strong> Schedule:</strong> {{ $schedule->schedule
                                        }}</span></li>
                                <li class="list-group-item"><span><strong> Lecture Unit:</strong> {{
                                        $schedule->lecture_unit }}</span></li>
                                <li class="list-group-item"><span><strong> Laboratory Unit:</strong> {{
                                        $schedule->laboratory_unit }}</span></li>
                                <li class="list-group-item"><span><strong> Room :</strong> {{ $schedule->room }}</span>
                                </li>
                            </ul>
                            @endif
                        </div>
        ...
        <div class="modal fade" id="weightModal" wire:ignore.self data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <form class="w-100" wire:submit.prevent="updateWeight('weightModal')">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" data-bs-dismiss="modal" id="weightModalclose"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body row">
                            @foreach ($temp_terms as $key =>$value )
                            <div class="col-md-6 mb-3">
                                <label for="weight" class="form-label">{{ $value['term_name'] }} weight
                                    percentage</label>
                                <input type="number" min="1" step="0.1" id="weight"
                                    wire:model="temp_terms.{{ $key }}.weight" placeholder="Term Weight"
        ...
        <div class="modal fade" id="lablecweightModal" wire:ignore.self data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="number" min="1" step="0.1" id="weight" wire:model="lecture_weight"
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="weight" class="form-label">{{ $value->fullname }} : {{ $value->schedule_from
                                    }} - {{ $value->schedule_to }}</label>
                                <input type="number" min="1" step="0.1" id="weight"
                                    wire:model="laboratory_schedules_weight.{{ $key }}.weight"
        ...
        <div class="modal fade" id="attendanceModal" wire:ignore.self data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <form class="w-100">
