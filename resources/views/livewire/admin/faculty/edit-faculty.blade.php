        ...
        <form wire:submit.prevent="save()">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="department_id"   id="department_id" @if(intval($detail['college_id']) == 0){{ '' }} @endif wire:model="detail.department_id" class="form-select @error('detail.department_id') is-invalid @enderror">  
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="designation_id"  id="designation_id" wire:model="detail.designation_id" class="form-select @error('detail.department_id') is-invalid @enderror">  
