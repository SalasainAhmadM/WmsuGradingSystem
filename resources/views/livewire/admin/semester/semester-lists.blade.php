                ...
                <table class="table table-striped table-bordered position-relative" >
                    ...
                    <thead style="background:#952323;color:white;">
                        <tr class="align-middle">
                            ...
                            <th scope="col" class="px-4 ">Start-End</th>
                        ...
                        @forelse($table_data as $key =>$value)
                            <tr class="align-middle">
                                <th scope="row" class="px-4">{{($table_data->currentPage()-1)*$table_data->perPage()+$key+1 }}</th>
                                    ...
                                    <td class="px-4">
                                    {{ $months[$value->date_start_month-1]['month_name'].' '.$value->date_start_date }} - 
                                    {{ $months[$value->date_end_month-1]['month_name'].' '.$value->date_end_date }}
                                    </td>
                                    <td class="px-4">
