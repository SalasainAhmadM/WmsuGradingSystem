        ...
        <form wire:submit.prevent="save()">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" id="semester" disabled placeholder="Semester" wire:model.defer="detail.semester" class="form-control @error('detail.semester') is-invalid @enderror">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select id="startMonth" required disabled wire:model.live="detail.date_start_month" class="form-select @error('detail.date_start_month') is-invalid @enderror">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if($detail['date_start_month'] > 0)
                        <select id="startDate" required disabled wire:model="detail.date_start_date" class="form-control @error('detail.date_start_date') is-invalid @enderror">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select id="endMonth" required disabled wire:model.live="detail.date_end_month" class="form-select @error('detail.date_end_month') is-invalid @enderror">
                        <option value="">Select Month</option>
                        @foreach($months as $value)
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if($detail['date_end_month'] > 0)
                        <select id="endDate" required disabled wire:model="detail.date_end_date" class="form-control @error('detail.date_end_date') is-invalid @enderror">
