        ...
        <form wire:submit.prevent="save()">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" id="year_level" placeholder="Year level" wire:model.defer="detail.year_level" class="form-control @error('detail.year_level') is-invalid @enderror">
