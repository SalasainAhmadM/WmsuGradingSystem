    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between my-2 gap-2 row">
            ...
            <div class="d-flex col-7 justify-content-end gap-2">
                <a class="btn btn-primary" wire:navigate href="{{ route($route.'-add') }}">
                        ...
                        @forelse($table_data as $key =>$value)
                            <tr class="align-middle">
                                <th scope="row" class="px-4">{{($table_data->currentPage()-1)*$table_data->perPage()+$key+1 }}</th>
                                    ...
                                    <td class="px-4">
                                        <a class="btn btn-outline-primary" wire:navigate href="{{ route('department-lists-college',$value->id) }}">
                                            Departments
                                        </a>
                                    </td>
                                    <td class="px-4">
                                        <div class="d-flex justify-content-center gap-2">
                                            <!-- <a href="{{ route($route.'-view',$value->id) }}" type="button" wire:navigate  class="btn btn-outline-secondary d-flex justify-content-center items-center">
                                            ...
                                            <a href="{{ route($route.'-edit',$value->id) }}" type="button" wire:navigate  class="btn btn-outline-success d-flex justify-content-center items-center">
                                            ...
                                            @if($value->is_active)
                                                <a href="{{ route($route.'-delete',$value->id) }}" type="button" wire:navigate  class="btn btn-outline-danger d-flex justify-content-center items-center">
                                            ...
                                            @else
                                                <a href="{{ route($route.'-activate',$value->id) }}" type="button" wire:navigate  class="btn btn-outline-warning d-flex justify-content-center items-center">
